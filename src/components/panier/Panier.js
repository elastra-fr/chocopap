...
function Panier({close, showPanier, emptyCart, cartItems, sumCart, removeItem, updateItem, specBoutique}) {

  return (
    <div id='panier' className={`${showPanier? "showPanier" : "hidePanier"} ${specBoutique}`}>
