...
{product !==undefined && <main id='singleProductMain'>
  ...
  <div id="infosWrapper">
    ...
    <div className='contCartButton'>
      ...
      <NewSmartCartButton id={id} getQte={props.getQteItem} newQte={props.getQteItem(id)} updateItem={props.updateItem} removeItem={props.removeItem} gestionCart={props.gestionCart} urlImage={product[0].attributes.image} name={product[0].attributes.title} price={product[0].attributes.price} />
